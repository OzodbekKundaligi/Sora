...
async function main() {
  process.stdout.write('[dev] Starting site and bot...\n');

  if (await isPortInUse(sitePort)) {
    process.stdout.write(`[dev] Port ${sitePort} is already in use. Reusing the existing site instance.\n`);
  } else {
